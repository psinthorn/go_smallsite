...
// AdminPromotionTypes
func (rp *Repository) AdminRateTypes(w http.ResponseWriter, r *http.Request) {
...
func (rp *Repository) RateType(w http.ResponseWriter, r *http.Request) {
...
func (rp *Repository) RateTypeForm(w http.ResponseWriter, r *http.Request) {
	st := r.URL.Query().Get("status")
	if st == "" {
		st = "enable"
	}
...
func (rp *Repository) AddRateType(w http.ResponseWriter, r *http.Request) {
...
// Update promotion
func (rp *Repository) UpdateRateType(w http.ResponseWriter, r *http.Request) {
	//form := forms.New(r.PostForm)
	err := r.ParseForm()
	if err != nil {
		helpers.ServerError(w, err)
...
// Delete
func (rp *Repository) DeleteRateType(w http.ResponseWriter, r *http.Request) {
	id, err := strconv.Atoi(chi.URLParam(r, "id"))
	if err != nil {
		helpers.ServerError(w, err)
	}
	...
	rp.App.Session.Put(r.Context(), "success", "rate type is deleted")
	http.Redirect(w, r, "/admin/rates-types", http.StatusSeeOther)
}
